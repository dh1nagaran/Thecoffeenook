...
const Menu = () => {
  ...
  const categories = ["All", ...new Set(product.products.map((p) => p.category))];
  console.log(categories)
  const filteredProducts = selectedCategory === "All" ? product.products : product.products.filter((p) => p.category === selectedCategory);
  return (
